#include "..\Public\VIBuffer_LineInstance.h"
#include "Pipeline.h"

CVIBuffer_LineInstance::CVIBuffer_LineInstance(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CVIBuffer(pDevice, pDeviceContext)
{

}

CVIBuffer_LineInstance::CVIBuffer_LineInstance(const CVIBuffer_LineInstance & rhs)
	: CVIBuffer(rhs)
...
HRESULT CVIBuffer_LineInstance::InitializePrototype(string pShaderFilePath, _uint iNumInstance)
{
...
HRESULT CVIBuffer_LineInstance::Initialize(void * pArg)
{
...
HRESULT CVIBuffer_LineInstance::Update(_double TimeDelta)
{
...
HRESULT CVIBuffer_LineInstance::Render(_uint iPassIndex)
{
...
CVIBuffer_LineInstance * CVIBuffer_LineInstance::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext, string pShaderFilePath, _uint iNumInstance)
{
	CVIBuffer_LineInstance*	pInstance = new CVIBuffer_LineInstance(pDevice, pDeviceContext);
...
CComponent * CVIBuffer_LineInstance::Clone(void * pArg)
{
	CVIBuffer_LineInstance*	pInstance = new CVIBuffer_LineInstance(*this);
...
void CVIBuffer_LineInstance::Free()
{
	__super::Free();
